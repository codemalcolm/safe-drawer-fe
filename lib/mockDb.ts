import { Card, AccessLog, Device, Notification, Drawer } from "./types";
...
export const INITIAL_DRAWERS: Drawer[] = [
  {
    id: "DRW-001",
    name: "Sklad A – Hlavní šuplík",
    location: "Budova A, patro 1, místnost 104",
    description: "Hlavní úložný šuplík pro skladové klíče a dokumenty.",
    isLocked: true,
  ...
  },
  {
    ...
    location: "Budova B, patro 2, kancelář 205",
    description: "Archivní šuplík pro citlivé dokumenty.",
    isLocked: false,

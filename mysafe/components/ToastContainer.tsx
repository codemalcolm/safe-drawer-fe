  ...
  return (
    <div className="fixed top-[72px] right-4 z-[200] flex flex-col gap-2 w-80">
      {toasts.map((t) => (
        <div
          key={t.id}
          className={`flex items-start gap-3 bg-white rounded-xl shadow-xl border border-slate-100 border-l-4 px-4 py-3 ${styles[t.type]} animate-in slide-in-from-right-4 duration-200`}
        >

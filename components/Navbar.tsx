...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-slate-950 border-b-2 border-teal h-[60px] flex items-center px-4 md:px-6 gap-2">
      ...
      {/* Nav links */}
      <div className="flex items-stretch ml-2 mr-auto gap-0 overflow-x-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">

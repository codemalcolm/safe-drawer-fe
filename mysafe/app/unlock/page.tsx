    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="text-slate-400 text-sm mt-0.5">
          Vzdálené odemknutí zabezpečeného šuplíku
        </p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center text-center py-10">
        {/* Icon */}
        <div className="text-7xl mb-5 select-none">{isOffline ? "🔒" : "🔓"}</div>

        <h2 className="font-mono font-bold text-xl text-slate-800 mb-2">
          Vzdálené odemknutí šuplíku
        </h2>
        <p className="text-slate-400 text-sm max-w-sm mb-8">
          Tato funkce umožňuje vzdáleně odemknout zabezpečený šuplík. Akce bude zaznamenána v
          historii přístupů.
        </p>
